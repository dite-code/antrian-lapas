...
<div class="container">
	<div class="row">
		<div class="col-12 text-center p-3">
			...
			<button type="button" class="btn btn-light btn-lg round25" onclick="play('Antrian Nomor. <?= $textwbp;?>, Silahkan ke Teler 2.')">
...
<script>
	...
	function play (){
		...
		var txt = "Antrian Nomor. "+ noantri[0] + ",. "+noantri[1]+" "+noantri[2]+" "+noantri[3]+", Silahkan ke Loket 2.";
		//alert(txt);
